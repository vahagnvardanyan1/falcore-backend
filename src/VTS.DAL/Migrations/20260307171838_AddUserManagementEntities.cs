        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasAccessToAllVehicles = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedDateUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedDateUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserVehicleAccesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserVehicleAccesses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserVehicleAccesses_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTenantAccesses_UserId_TenantId",
                table: "UserTenantAccesses",
                columns: new[] { "UserId", "TenantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserVehicleAccesses_UserId_VehicleId",
                table: "UserVehicleAccesses",
                columns: new[] { "UserId", "VehicleId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserVehicleAccesses_VehicleId",
                table: "UserVehicleAccesses",
                column: "VehicleId");
        }
