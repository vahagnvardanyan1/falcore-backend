...
public class VehicleTechnicalInspectionsController(IVehicleTechnicalInspectionService service) : BaseController
{
    [HttpGet]
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] VehicleTechnicalInspectionDto dto, CancellationToken cancellationToken)
    {
        try
        {
    ...
    [HttpPut("{id:long}")]
    public async Task<IActionResult> Update(long id, [FromBody] VehicleTechnicalInspectionDto dto, CancellationToken cancellationToken)
    {
        try
        {
