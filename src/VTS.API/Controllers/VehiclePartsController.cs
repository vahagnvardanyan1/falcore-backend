...
public class VehiclePartsController(IVehiclePartService service) : BaseController
{
    [HttpGet]
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] VehiclePartDto dto, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:long}")]
    public async Task<IActionResult> Update(long id, [FromBody] VehiclePartDto dto, CancellationToken cancellationToken)
    {
